...
const createJudgeAttestation = async (signer: Signer, address: string, veredict: boolean, timeLock: number) => {
  ...
  const schemaEncoder = new SchemaEncoder('address ADDRESS,uint256 JUDGE,bool FINAL_VERDICT,uint256 TIMELOCK')
  ...
  const schemaUID = '0xbf564b3ed16b42c3bcfad0e6f5f6016b9657dabc57a4c4e37706b6d017918a55'
